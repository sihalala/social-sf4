...
include_once $this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Dbal/SchemaAssetsFilterManager.php';
include_once $this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Dbal/BlacklistSchemaAssetFilter.php';
include_once $this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Dbal/RegexSchemaAssetFilter.php';
...
include_once $this->targetDirs[3].'/src/EventListener/LikeNotificationSubscriber.php';
...
$a->setSQLLogger($b);
$a->setSchemaAssetsFilter(new \Doctrine\Bundle\DoctrineBundle\Dbal\SchemaAssetsFilterManager([0 => new \Doctrine\Bundle\DoctrineBundle\Dbal\BlacklistSchemaAssetFilter([0 => 'lock_keys']), 1 => new \Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter('~^(?!sessions)~')]));
...
$d->addEventSubscriber(new \App\EventListener\LikeNotificationSubscriber());
