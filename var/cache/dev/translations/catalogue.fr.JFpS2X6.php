...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'This e-mail is already used' => 'Cet e-mail est déjà pris',
    'This username is already used' => 'Ce nom d\'utilisateur est déjà utilisé',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'email.registration' => '<h3>Bienvenue dans l\'application!</h3>
<p>Bonjour %name%! Vous êtes inscrit dans l\'application!</p>
<p>Veuillez confirmer le compte en cliquant sur ce lien
<a href="%confirm-link%">lien</a>.
</p>
<p>Pour vous connecter, accédez à <a href="%login-link%">page de connexion</a>.</p>
<p>Merci!</p>',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'email.registration' => '<h3>Welcome to the app!</h3>
