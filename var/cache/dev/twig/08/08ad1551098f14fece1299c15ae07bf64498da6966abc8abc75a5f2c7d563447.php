...
class __TwigTemplate_127c365995816e999496d438243d04fc2311f69f84499db09464463eb881b8e0 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["id"] => $context["post"]) {
            // line 7
            echo "        <p><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", ["id" => $context["id"]]), "html", null, true);
            echo "\">ID ";
        ...
        <p>";
            // line 9
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "text", [], "any", false, false, false, 9), "html", null, true);
            echo "</p>
    ";
        }
    ...
    {
        return array (  104 => 9,  100 => 8,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {% for id, post in posts %}
        <p><a href=\"{{ path('blog_show', {'id': id}) }}\">ID {{ id }}</a></p>
        <h3>{{ post.title }}</h3>
        <p>{{ post.text }}</p>
    {% endfor %}
{% endblock %}", "blog/index.html.twig", "/home/vagrant/social-sf4/templates/blog/index.html.twig");
    }
}
