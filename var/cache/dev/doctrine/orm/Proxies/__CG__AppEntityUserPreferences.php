 ...
 */
class UserPreferences extends \App\Entity\UserPreferences implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\UserPreferences' . "\0" . 'id', '' . "\0" . 'App\\Entity\\UserPreferences' . "\0" . 'locale'];
        }
